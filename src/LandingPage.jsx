...
const LandingPage = () => {
  useEffect(() => {
    // Script untuk menginisialisasi AOS dan fungsi lainnya
    const initScripts = () => {
      // Inisialisasi AOS
      if (window.AOS) {
        window.AOS.init({
    ...
    // Load AOS script jika belum dimuat
    if (!window.AOS) {
      const aosScript = document.createElement('script');
      aosScript.src = 'https://unpkg.com/aos@2.3.1/dist/aos.js';
      aosScript.onload = initScripts;
      ...
      <header id="header" className="bg-white/80 backdrop-blur-lg sticky top-0 z-50 border-b border-gray-200 transition-all duration-300">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            {/* Logo */}
            <a href="#" className="text-2xl font-bold text-gray-900">Edu<span className="text-indigo-600">Task</span></a>
            
            {/* Desktop Navigation */}
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-gray-600 hover:text-indigo-600 font-medium transition-colors">Kelebihan</a>
              <a href="#how-it-works" className="text-gray-600 hover:text-indigo-600 font-medium transition-colors">Cara Kerja</a>
              <a href="#faq" className="text-gray-600 hover:text-indigo-600 font-medium transition-colors">FAQ</a>
              <a href="/portfolio" className="text-gray-600 hover:text-indigo-600 font-medium transition-colors">Portfolio</a>
            </nav>
            
            {/* Desktop Action Button */}
            <div className="hidden md:flex items-center">
              <a href="/" className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-5 rounded-lg shadow-lg hover:shadow-indigo-500/50 transition-all transform hover:scale-105 duration-300">Register</a>
            </div>
        ...
        <div id="mobile-menu" className="hidden md:hidden bg-white border-t border-gray-200">
          <nav className="flex flex-col space-y-2 p-4">
            <a href="#features" className="text-gray-600 hover:text-indigo-600 font-medium p-2 rounded-md">Kelebihan</a>
            <a href="#how-it-works" className="text-gray-600 hover:text-indigo-600 font-medium p-2 rounded-md">Cara Kerja</a>
            <a href="#faq" className="text-gray-600 hover:text-indigo-600 font-medium p-2 rounded-md">FAQ</a>
            <a href="/portfolio" className="text-gray-600 hover:text-indigo-600 font-medium p-2 rounded-md">Portfolio</a>
            <a href="/" className="w-full text-center bg-indigo-600 hover:bg-indigo-700 text-white font-semibold mt-2 py-2 px-5 rounded-lg shadow-lg">Register</a>
          </nav>
        </div>
      </header>
        ...
        <section className="py-20 md:py-32 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div data-aos="fade-up">
              ...
              <a href="/" className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-full shadow-xl transition-transform transform hover:scale-105 duration-300">Daftar Akun Gratis</a>
            </div>
            <div data-aos="fade-up" data-aos-delay="200" className="mt-16">
              <img src="https://edutask-app.vercel.app/Screenshot_2025-08-31-06-30-37-12.jpg" alt="Dasbor EduTask" className="rounded-2xl shadow-2xl mx-auto ring-1 ring-gray-200" />
            </div>
          </div>
        </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                ...
                <div className="text-center" data-aos="fade-up">
                  <div className="relative inline-block">
                    <div className="w-20 h-20 mx-auto bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center text-2xl font-bold ring-8 ring-gray-50">1</div>
                  </div>
                ...
                <div className="text-center" data-aos="fade-up" data-aos-delay="150">
                  <div className="relative inline-block">
                    <div className="w-20 h-20 mx-auto bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center text-2xl font-bold ring-8 ring-gray-50">2</div>
                  </div>
                ...
                <div className="text-center" data-aos="fade-up" data-aos-delay="300">
                  <div className="relative inline-block">
                    <div className="w-20 h-20 mx-auto bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center text-2xl font-bold ring-8 ring-gray-50">3</div>
                  </div>
        ...
        <section className="bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
            <div className="bg-indigo-600 rounded-2xl p-8 md:p-12 text-center" data-aos="zoom-in">
              ...
              <a href="/" className="mt-8 inline-block bg-white hover:bg-gray-100 text-indigo-600 font-bold py-3 px-8 rounded-full shadow-lg transition-transform transform hover:scale-105 duration-300">Mulai Gratis Sekarang</a>
            </div>
          </div>
        </section>
      </main>
        ...
        <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2 lg:col-span-1">
              <a href="#" className="text-2xl font-bold text-white">Edu<span className="text-indigo-400">Task</span></a>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><a href="#features" className="hover:text-indigo-400">Kelebihan</a></li>
                <li><a href="#how-it-works" className="hover:text-indigo-400">Cara Kerja</a></li>
